...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            Purchase Finish Products
        </div>

        <div class="card-body">
            <form action="{{ route("admin.finish.product.purchase.store") }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                            ...
                            <input type="hidden" id="showroom_id" name="showroom_id" value="{{$showroom_id}}">
