                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" class="form-control material_id" value="{{$detail->color_id}}" name="color_id[]">
                            </td>
                            <td>
                                <input type="text" class="form-control quantity" value="{{$detail->qty}}" name="quantity[]">
                            </td>
                            <td>
                                <input type="text" class="form-control price" value="{{$detail->selling_price}}" name="price[]">
                            </td>
                            <td>
                                <input type="text" class="form-control line_total" value="{{$detail->line_total}}" name="line_total[]">
                            </td>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
                    ...
                    <input type="number" name="discount" value="{{$orders->discount}}" id="discount" class="form-control">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('paid') ? 'has-error' : '' }}">
                    ...
                    <input type="number" name="paid" id="paid" class="form-control" value="{{$orders->paid}}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('due') ? 'has-error' : '' }}">
                    <label for="name">Due *</label>
                    <input type="number" name="due" id="due" class="form-control" value="{{$orders->due}}">
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $( "#product_color_id" ).change(function() {
            ...
            $.ajax({
                url: '/admin/add-to-return-cart/'+department_id+'/'+product_color_id,
                type: 'GET',
                cache: false,
